...
| --- | --- | --- | ---: | --- | --- |
| `DATE.COM` | shipped / full | PL/M-80 and 8080 assembly: `date.plm`, `mcd80a.asm`, `makedate.lib` | 3,247 | 0100h--0DAEh; 35,921 B remain | profile-and-directory |
...
| `DEVICE.COM` | shipped / full | PL/M-80 and 8080 assembly: `device.plm`, `mcd80a.asm` | 7,268 | 0100h--1D63h; 31,900 B remain | profile-and-directory |
...
| `HEXCOM.COM` | candidate / dev | 8080 assembly: `hexcom.asm` | 1,131 | 0100h--056Ah; 38,037 B remain | not-run |
...
| `SHOW.COM` | shipped / full | PL/M-80: `show.plm`, `scan.plm`, `search.plm`, `disp.plm`, `dpb80.plm`, `util.plm`, `timest.plm` | 8,376 | 0100h--21B7h; 30,792 B remain | profile-and-directory |
...
| `PATCH.COM` | candidate / dev | 8080 assembly: `patch.asm` | 2,369 | 0100h--0A40h; 36,799 B remain | not-run |
| `SUBMIT.COM` | shipped / full | PL/M-80 and 8080 assembly: `submit.plm`, `subrsx.asm`, `parse.asm`, `getf.asm`, `mcd80a.asm` | 5,376 | 0100h--15FFh; 33,792 B remain | profile-and-directory |
...
| `PIP.COM` | shipped / full | PL/M-80 and 8080 assembly: `pip.plm`, `mcd80f.asm`, `inpout.asm` | 8,632 | 0100h--22B7h; 30,536 B remain | profile-and-directory |
...
| `SET.COM` | shipped / full | PL/M-80 and 8080 assembly: `set.plm`, `parse.asm`, `dirlbl.asm`, `mcd80a.asm` | 10,368 | 0100h--297Fh; 28,800 B remain | profile-and-directory |
| `SID.COM` | candidate / dev | 8080 assembly: `prs0mov.asm`, `prs1asm.asm`, `prs2mon.asm`, `makedate.lib` | 7,936 | 0100h--1FFFh; 31,232 B remain | not-run |
