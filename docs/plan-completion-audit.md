...
| Project-owned tools | `project-utilities.md`, `cpm3-video-acceptance.md`, `cpm3-command-history.md`, and the full-profile simulator matrix | The original audit is complete for six gap tools plus VIDTEST. Post-C6 M5 additionally admits the reproducible `!!` CCP extension and strict-8080 `HIST.COM`; the pseudographic text-interface example remains planned. |
