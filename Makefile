...
distribution-cosim-check: all
	...
	CPM_PLUS_JUKU_EXTRA_COMMAND4='PIP COPY.TXT=PROFILE.SUB' \
	CPM_PLUS_JUKU_EXTRA_COMMAND5='DUMP COPY.TXT' \
	CPM_PLUS_JUKU_EXTRA_MARKER5=0000 \
	CPM_PLUS_JUKU_EXTRA_MARKERS5='44 49 52' \
